      ...
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 lg:pl-[320px] gap-7 flex flex-col min-h-screen py-4 justify-center">
        <div>
          ...
          <p className="text-xl text-stone-600">
            Welcome to the ENCS691K Auction Platform, the ultimate destination
            for online auctions and bidding excitement. Founded in 2024, we are
            dedicated to providing a dynamic and user-friendly platform for
            buyers and sellers to connect, explore, and transact in a secure and
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            At ENCS691K Auction Platform, our mission is to revolutionize the
            way people buy and sell items online. We strive to create an
            engaging and trustworthy marketplace that empowers individuals and
            businesses to discover unique products, make informed decisions, and
            enjoy the thrill of competitive bidding.
          </p>
        </div>
        <div>
          <h3
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            ENCS691K Auction Platform was born out of a passion for connecting
        ...
        <div>
          ...
          <p className="text-xl text-stone-600">
            Whether you're looking to buy, sell, or simply explore, ENCS691K
            Auction Platform invites you to join our growing community of
            auction enthusiasts. Discover new opportunities, uncover hidden
            gems, and experience the thrill of winning your next great find.
          </p>
        </div>
        <div>
