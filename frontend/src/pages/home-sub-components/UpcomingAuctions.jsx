                ...
                >
                  ...
                  <div className="flex justify-between">
                    <p className="text-stone-600 font-semibold">
                      {element.currentBid && element.currentBid > 0 ? "Current Bid:" : "Starting Bid:"}
                    </p>{" "}
                    <p className="text-[#fdba88 font-semibold]">
                      $ {element.currentBid && element.currentBid > 0 ? element.currentBid : element.startingBid}
                    </p>{" "}
                  </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex justify-between">
                    ...
                    <p className="text-[#fdba88 font-semibold]">
                      Rs. {element.currentBid && element.currentBid > 0 ? element.currentBid : element.startingBid}
                    </p>{" "}
                  </div>
                  <div className="flex flex-col">
                    <p className="text-stone-600 font-bold">Starting Time:</p>
